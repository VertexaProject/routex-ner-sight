  ...
  head: () => ({
    meta: [
      ...
      { title: "RouteX — NER Logistics & Accessibility Intelligence" },
      {
        name: "description",
        content:
          "RouteX: AI-powered logistics and accessibility intelligence for India's North Eastern Region.",
      },
      { property: "og:title", content: "RouteX — NER Logistics & Accessibility Intelligence" },
      {
        property: "og:description",
        content:
          "Road status, incidents and convoy routing across the eight North Eastern states.",
      },
